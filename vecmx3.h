 ...
 *
 * @brief   Basic 3×1 and 3×3 vector/matrix library (q::Vec3, q::Mx3).
 *
 * Embedders that need Vec3/Mx3 stack types should include rpn-matrix.h
 * (which includes this header) in addition to rpn.h.
 *
 */
...
/* basic classes and methods for 3-element vector / 3×3 matrix math */
namespace q {
  class Mx3;
  class Vec3;

/**
 * @brief Simple 3×1 vector class
 */
  class Vec3 {
  public:
